...
export const LinkSection = ({
  ...
  const profileAdress = `https://twitter.com/${twitter}`

  const str = undefined || company
  const removedAt = typeof str === 'string' ? str.substring(1) : ''
  ...
  return (
    <div className="col-start-1 lg:col-start-2 col-end-3 grid sm:grid-cols-2 gap-y-4 md:gap-y-5">
      <Link
        ...
        hover={null}
      />
      <Link title={site} icon={siteIcon} link={site} hover="hover:underline" />
      <Link
        title={twitter}
        icon={twitterIcon}
        link={profileAdress}
