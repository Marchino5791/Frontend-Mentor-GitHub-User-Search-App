...
const moon: JSX.Element = (
  <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill="#697C9A"
      fillRule="nonzero"
      className="group-hover:fill-project-black"
    />
  </svg>
)
...
const sun: JSX.Element = (
  <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
    <g
      fill="#FFF"
      fillRule="nonzero"
      className="group-hover:fill-project-darksilver"
    >
...
export const Header: React.FC = () => {
  ...
  return (
    <header className="flex justify-between mb-6 sm:mb-9">
      <p className="font-bold text-[1.625rem] dark:text-white">devfinder</p>

      <p
        onClick={handleThemeSwitch}
        className="flex justify-between gap-4 items-center group text-[0.8125rem] font-bold uppercase tracking-widest text-project-darksilver dark:text-white hover:text-project-black dark:hover:text-project-darksilver cursor-pointer"
      >
